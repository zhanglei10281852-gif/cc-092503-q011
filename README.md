...
- 调查案件：关联异常可汇聚为调查案件，按接收批次、保管位置、谱系祖先和时间窗口扫描候选关联，人工确认后统一执行隔离或观察措施；案件保存假设、证据版本、责任人、处置步骤和截止时间，严重度只升不降；结案前必须逐项解释受影响样品，并由另一名人员批准解除措施；候选扫描与逾期检查任务可安全重跑，案件详情稳定展示关联依据与未完成动作。
